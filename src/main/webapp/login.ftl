    ...
    <body>
        ...
        <div class="parallax-container valign-wrapper" style="height: 100vh;">
            <div class="parallax"><img alt="Fondo" src="assets/images/bg.jpg"/></div>
                <div class="row">
                    <div class="card-panel blue-grey lighten-5 col s12" style="padding: 20px;">
                            <form>
                                <div class="row">
                                ...
                                <div class="row">
                                    <div class="input-field col s12">
                                        <a class="light-blue accent-2 waves-effect waves-light btn"><i class="material-icons right">arrow_forward</i>Conectar</a>
                                    </div>
                                </div>
                            </form>
                    </div>
