 ...
 * @author Miguel
 */
@WebServlet(name = "RecuperarPass1", urlPatterns = {"/recuperarpass1"})
public class RecuperarPass1 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Template temp = Configuration.getInstance().getFreeMarker().getTemplate("/recuperarpass1.ftl");
