...
public class AdminServicios
{
    ...
    public AjaxResponse addAsig(int id_curso, String nombre)
    {
        ...
        int insertedId = dao.addAsig(asignatura);
        if (insertedId != 0)
        {
            HashMap<String, String> datos = new HashMap<>();
            datos.put(Parametros.ID, String.valueOf(insertedId));
    ...
    private static final Logger LOG = Logger.getLogger(AdminServicios.class.getName());
}
