...
public class VerNotasAlumnado extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        helper.mostrarPlantilla("/panel/profesor/notas_alumnado.ftl", response.getWriter(),
            new AbstractMap.SimpleEntry<>("notas", ps.getAllNotas(email))
        );
    ...
    private static final Logger LOG = Logger.getLogger(VerNotasAlumnado.class.getName());
