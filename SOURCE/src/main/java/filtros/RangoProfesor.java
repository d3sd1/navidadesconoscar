...
public class RangoProfesor implements Filter
{

    private FilterConfig filterConfig = null;

    public RangoProfesor()
    {
    }
            ...
            throws IOException, ServletException
    {
        ...
        try
        {
            ...
            else if (rango != null && !rango.toString().equals("profesor"))
            {
    ...
    private static final Logger LOG = Logger.getLogger(RangoProfesor.class.getName());
